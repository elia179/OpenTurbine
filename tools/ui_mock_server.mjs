...
function fullTelemetry() {
  return {
    ...
    n1_healthy: true, n2_healthy: true, tot_healthy: true, oil_healthy: true, p1_healthy: true, p2_healthy: true, oil_temp_healthy: true, tit_healthy: true, fuel_press_healthy: true, fuel_flow_healthy: true, batt_healthy: true, torque_healthy: true,
