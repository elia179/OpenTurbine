...
function makeHardware() {
  return {
    ...
    safety: { overspeed: true, overtemp: true, low_oil: true, oil_zero: true, flameout: true, hot_start: true, oil_temp_high: true, fuel_press_low: true, batt_low: true, surge: true },
